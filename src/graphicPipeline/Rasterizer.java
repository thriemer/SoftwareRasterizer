...
public class Rasterizer {
	...
	private static Vec3 calcBarycentricCoords(float x, float y, float tx1, float ty1, float tx2, float ty2, float tx3,
			float ty3) {
		Vec3 barycentricRT = new Vec3(0, 0, 0);
		...
		barycentricRT.y = w2top / w1bottem;
